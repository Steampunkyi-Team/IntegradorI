 ...
 * @author barre
 */
public class Empaquetado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jPanel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 230, 30, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Empaquetado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Empaquetado().setVisible(true);
            }
        });
    }
